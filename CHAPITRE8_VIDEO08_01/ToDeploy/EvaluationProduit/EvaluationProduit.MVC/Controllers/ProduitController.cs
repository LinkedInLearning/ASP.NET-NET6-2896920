...
namespace EvaluationProduit.MVC.Controllers
{
    public class ProduitController : Controller
    {
        ...
        public ProduitController(IProduitService produitService, IWebHostEnvironment webHostEnvironment, ProduitContext produitContext, IProduitMapper produitMapper, IProduitRepository produitRepository)
        {
        ...
        public IActionResult Index()
        {
            ...
            ChargerDonnées();
            //var test = ProduitRepository.Produits();
            return View(_produitMapper.MapProduitsEnProduitModels(ProduitRepository.Produits().ToList()));
        }
